...
public interface MessageDAO extends JpaRepository<Message, Integer> {
    ...
    int countByToUserIdAndConversationIdAndHasReadIsFalse(int userId, String conversationId);

    int countByToUserIdAndHasReadIsFalse(int toId);

    int countByFromUserIdAndToUserIdAndHasReadIsFalse(int fromId, int toId);
    ...
    void deleteAllByFromUserId(Integer fromId);
    void deleteAllByToUserId(Integer fromId);
